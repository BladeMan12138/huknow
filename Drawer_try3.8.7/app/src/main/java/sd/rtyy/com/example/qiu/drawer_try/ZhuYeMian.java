...
import sd.rtyy.com.example.qiu.drawer_try.Collectors.FragBaseActivity;
...
public class ZhuYeMian extends FragBaseActivity {
...
//FragmentManager manager=getFragmentManager();
        ...
        Boolean isFirstLoad = sp.getBoolean("isFirstLoad", true);//如果没有取到值，默认为true
        if(isFirstLoad){
            //第一次登陆
            editor.putBoolean("isFirstLoad", false);//改变状态
            editor.commit();
            initWindow();//显示提示图画
        }
    }
    ...
    public void initWindow(){
        ...
        img.setImageResource(R.drawable.guide3);

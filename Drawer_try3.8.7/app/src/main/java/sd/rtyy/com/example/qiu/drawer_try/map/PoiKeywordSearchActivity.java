...
public class PoiKeywordSearchActivity extends Activity implements
        ...
        PoiSearch.OnPoiSearchListener, View.OnClickListener, Inputtips.InputtipsListener, LocationSource,AMapLocationListener {
    private AMap aMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tele = (TextView)findViewById(R.id.telephone);
...
//        title.setText(marker.getTitle());
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(PoiKeywordSearchActivity.this,rCode,Toast.LENGTH_SHORT).show();
        }

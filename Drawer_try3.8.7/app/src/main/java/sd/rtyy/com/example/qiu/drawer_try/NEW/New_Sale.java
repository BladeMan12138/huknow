...
public class New_Sale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_up_4);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(New_Sale.this, "已发布您的促销信息", Toast.LENGTH_LONG).show();
            }
        });
        init();
    }
    //初始化控件
    private void init() {
        img_btn = (ImageButton) findViewById(R.id.imageView4);
